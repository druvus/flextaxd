...
from flextaxd.core.memory_optimized_tree import (
    ...
    MemoryOptimizedOperations, NodeCacheEntry, create_memory_optimized_tree,
...
class TestStreamingTaxonomyTree:
    ...
    def test_stream_by_rank(self, streaming_tree):
        ...
        superkingdom_nodes = list(streaming_tree.stream_by_rank(TaxonomicRank.SUPERKINGDOM))
...
class TestMemoryOptimizedOperations:
    ...
    def test_streaming_distance_matrix(self, memory_ops):
        ...
        for (id1, id2, distance) in distances:
            ...
            assert distance is not None or distance is None  # Some may be None if no LCA
...
class TestPerformanceComparison:
    ...
    def create_large_mock_provider(self, num_nodes: int = 1000):
        ...
        for i in range(1, num_nodes + 1):
            ...
            provider.nodes[i] = TaxonomyNode(i, f"Node_{i}", TaxonomicRank.SPECIES, parent_id)
