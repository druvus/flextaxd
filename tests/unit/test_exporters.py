...
from flextaxd.exporters.base import (
    TaxonomyExporter,
    FileBasedExporter,
    DirectoryBasedExporter,
)
...
class TestAccession2TaxidExporter:
    ...
    def _create_test_tree_with_genomes(self):
        ...
        # Add genomes
        genome1 = GenomeInfo(genome_id="NC_000913", tax_id=562, sequence_type="genome")
        genome2 = GenomeInfo(genome_id="NP_414542", tax_id=562, sequence_type="protein")
...
class TestGenomeSizesExporter:
    ...
    def _create_genome_tree_with_sizes(self):
        ...
        tree.add_genome(
            GenomeInfo(
                "NC_000913", 562, sequence_type="genome", sequence_length=4641652
            )
        )
    ...
    def test_exporters_handle_empty_trees(self):
        ...
        for exporter in exporters:
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                with pytest.raises(
                    ExportError, match="Cannot export empty taxonomy tree"
                ):
