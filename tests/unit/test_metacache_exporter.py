...
class TestMetaCacheExporter:
    ...
    def test_export_with_compression(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch('flextaxd.utils.subprocess_utils.compress_file') as mock_compress:
                exporter.export(tree, output_path, format_type='ncbi_taxonomy', compress=True)
    ...
    def test_fasta_header_examples_generation(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert "# Use these header formats when creating FASTA files for MetaCache" in content
    ...
    def _create_tree_with_special_names(self):
        ...
        special = TaxonomyNode(
            tax_id=100, name="Special|Name\tWith\nChars", rank=TaxonomicRank.GENUS, parent_id=1
        )
