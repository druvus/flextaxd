...
AAAAAAAAAA"""
    ...
    def test_fasta_processor_silva_taxonomy_extraction(self):
        ...
        assert result1 == (
            "AACY020068177.1.1441.1464",
            "Bacteria;Actinobacteria;Actinobacteria;Acidimicrobiia",
        )
...
CCCCCCCCCC"""
        ...
        created_files = processor.split_fasta_by_sequence(
            input_file, output_dir, max_sequences_per_file=1
        )
...
AB000002\tAB000002.1\t789\t101112"""
    ...
    def test_genome_directory_manager(self, tmp_path: Path):
        ...
        (genomes_dir / "genome4.txt").write_text(
            "not a genome file"
        )  # Should be ignored
    ...
    def test_enhanced_genome_info_model(self):
        ...
        genome1 = GenomeInfo(
            genome_id="test_genome", tax_id=123, sequence_type="16S", source="SILVA"
        )
    ...
    def test_genome_info_with_file(self, tmp_path: Path):
        ...
        genome_bad = GenomeInfo(
            genome_id="bad_genome", tax_id=123, file_path="/nonexistent/path/file.fasta"
        )
