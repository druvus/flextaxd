"""Standard NCBI taxonomy format exporter."""
...
class NCBIExporter(DirectoryBasedExporter):
    """Exporter for standard NCBI taxonomy dump format."""
    ...
    def export(self, tree: TaxonomyTree, output_path: Path, **kwargs: Any) -> None:
        """Export taxonomy tree in NCBI dump format.
        ...
        logger.info(f"Exporting {tree.node_count} nodes to NCBI format: {output_path}")
        
        # Configuration options
        compress = kwargs.get('compress', False)
        names_file = kwargs.get('names_file', 'names.dmp')
        nodes_file = kwargs.get('nodes_file', 'nodes.dmp')
        
        # Create taxonomy files
        names_path = output_path / names_file
        nodes_path = output_path / nodes_file
        
        self._write_names_file(tree, names_path, compress)
        self._write_nodes_file(tree, nodes_path, compress)
        
        logger.info(f"NCBI export completed: {names_path}, {nodes_path}")
