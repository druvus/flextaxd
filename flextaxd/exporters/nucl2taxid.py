...
class Nucl2TaxidExporter(FileBasedExporter):
    ...
    def export(self, tree: TaxonomyTree, output_path: Path, **kwargs: Any) -> None:
        ...
        logger.info(f"Exporting {tree.node_count} nodes to Nucl2Taxid format: {output_path}")
        
        # Configuration options
        compress = kwargs.get('compress', False)
        include_genomes = kwargs.get('include_genomes', True)
        sequence_filter = kwargs.get('sequence_filter', 'nucleotide')  # nucleotide, protein, or all
    ...
    def _write_nucl2taxid_file(self, tree: TaxonomyTree, output_path: Path, 
                              compress: bool, sequence_filter: str) -> None:
    ...
    def _should_include_sequence(self, genome: Any, sequence_filter: str) -> bool:
        ...
        if sequence_filter == 'nucleotide':
            ...
            return seq_type in ['genome', '16s', 'nucleotide', 'dna', 'rna'] and seq_type not in ['protein', 'proteome']
