...
class SourmashExporter(FileBasedExporter):
    ...
    def export(self, tree: TaxonomyTree, output_path: Path, **kwargs: Any) -> None:
        ...
        logger.info(
            f"Exporting {tree.node_count} nodes to Sourmash format: {output_path}"
        )
    ...
    def _create_empty_taxonomy_file(
        self, output_path: Path, include_strain: bool, delimiter: str
    ) -> None:
                ...
                for node in tree:
                    ...
                    for genome in genomes:
                        ...
                        row_data = self._create_row_data(
                            ident, lineage, genome, include_strain
                        )
    ...
    def _create_row_data(
        self, ident: str, lineage: Dict[str, str], genome: Any, include_strain: bool
    ) -> List[str]:
