...
class TaxonomyExporter(ABC):
    ...
    def _ensure_output_path(self, output_path: Path, is_directory: Optional[bool] = None) -> None:
        ...
        if is_directory:
            ...
            if output_path.exists() and output_path.is_dir():
                raise ExportError(f"Output path is a directory, expected file: {output_path}")
