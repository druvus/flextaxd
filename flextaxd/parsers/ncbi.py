...
class NCBITaxonomyParser(DirectoryBasedParser):
        ...
        try:
            ...
            if file_path.is_file():
                ...
                return (
                    ...
                    and self._is_dump_file(names_file)
                    and self._is_dump_file(nodes_file)
                )
            ...
            with open(names_file, "r", encoding="utf-8") as f:
                for line_num, line in enumerate(f, 1):
                    ...
                    try:
                        ...
                        raise ParseError(
                            f"Error parsing names file line {line_num}: {e}"
                        )
    ...
    def _parse_nodes_file(
        self, nodes_file: Path, names_dict: Dict[int, str]
    ) -> TaxonomyTree:
