...
class QIIMETaxonomyParser(FileBasedParser):
    ...
    def can_parse(self, file_path: Path) -> bool:
        ...
        try:
            ...
            for line in lines:
                ...
                if ';' in line and any(prefix in line for prefix in ['d__', 'p__', 'c__', 'o__', 'f__', 'g__', 's__']):
                    return True
    ...
    def _parse_taxonomy_string(self, taxonomy_string: str) -> List[tuple[str, TaxonomicRank]]:
    ...
    def _parse_gtdb_level(self, level: str, position: int) -> tuple[TaxonomicRank, str]:
        ...
        rank = position_ranks[position] if position < len(position_ranks) else TaxonomicRank.CUSTOM
