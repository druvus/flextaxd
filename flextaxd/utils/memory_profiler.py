...
class MemoryProfiler:
    ...
    def stop_profiling(self) -> Optional[MemoryProfile]:
        ...
        logger.info(f"  Memory growth: {self._current_profile.memory_growth_mb:+.1f} MB")
...
def profile_memory(operation_name: Optional[str] = None, 
                  enable_snapshots: bool = False) -> Callable[[Callable[..., Any]], Callable[..., Any]]:
...
def check_memory_threshold(max_memory_mb: float, 
